...
const getInfo = async(event) => {
    ...
    if(cityVal === ""){
        city_name.innerHTML = "Write place name before search";
        datahide.classList.add('data_hide');

    }else{
        try{
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=8adacecc4c1e35c78d7e9c8dbbc632ee`;
